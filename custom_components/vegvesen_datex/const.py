...
CONF_SITE_ID = "site_id"                  # for weather, and legacy single-stretch travel time
CONF_SITE_IDS = "site_ids"                # for travel time - one or more stretches, accumulated if more than one
